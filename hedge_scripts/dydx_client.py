...
class DydxClient(object):
    ...
    def get_dydx_parameters(self, dydx_class_instance):
        ...
        self.dydx_margin_parameters['incrementalInitialMarginFraction'] = float(dydx_ETH_USD_data['incrementalInitialMarginFraction'])

        self.dydx_margin_parameters['initialMarginFraction'] = float(dydx_ETH_USD_data['initialMarginFraction'])
        self.dydx_margin_parameters["maintenanceMarginFraction"] = float(dydx_ETH_USD_data['maintenanceMarginFraction'])
        self.dydx_margin_parameters["oraclePrice"] = float(dydx_ETH_USD_data['oraclePrice'])
        self.dydx_margin_parameters["next_funding_at"] = dydx_ETH_USD_data['nextFundingAt']
        self.dydx_margin_parameters["next_funding_rate"] = float(dydx_ETH_USD_data['nextFundingRate'])

        # initial_margin_requirement
        self.dydx_margin_parameters["Initial_Margin_Requirement"] = abs(dydx_class_instance.short_size
        ...
        self.dydx_margin_parameters["Maintenance_Margin_Requirement"] = abs(dydx_class_instance.short_size
                                                                            * self.dydx_margin_parameters["oraclePrice"]
        ...
        self.dydx_margin_parameters["Total_Maintenance_Margin_Requirement"] = self.dydx_margin_parameters["Maintenance_Margin_Requirement"]
         ...
         # total_account_value
        self.dydx_margin_parameters["total_account_value"] = dydx_class_instance.collateral + dydx_class_instance.notional
        ...
        if self.dydx_margin_parameters["Total_Maintenance_Margin_Requirement"] != 0:
            self.dydx_margin_parameters["liquidation_price"] = self.dydx_margin_parameters["oraclePrice"] * (
                        1 + (self.dydx_margin_parameters["maintenanceMarginFraction"] * self.dydx_margin_parameters["total_account_value"]
                             / self.dydx_margin_parameters["Total_Maintenance_Margin_Requirement"]))
        else:
