...
if __name__ == "__main__":
    ...
    stgy.load_intervals()
    config["initial_parameters"]["aave"]["market_price"] = stgy.historical_data['close'][0]
    config["initial_parameters"]["aave"]["interval_current"] = stgy.historical_data['interval'][0]
    config["initial_parameters"]["aave"]["collateral"] = stgy.stk
    config["initial_parameters"]["dydx"]["market_price"] = stgy.historical_data['close'][0]
    config["initial_parameters"]["dydx"]["interval_current"] = stgy.historical_data['interval'][0]
    # print(config)
    stgy.launch(config)
